...
def crypto_BUY(ticker, amountD):
    r = robin_stocks.robinhood.orders.order_buy_crypto_by_price(ticker, amountD)
    print(r)

def crypto_SELL(ticker, amountD):
    r = robin_stocks.robinhood.orders.order_sell_crypto_by_price(ticker, amountD)
    print(r)
